...
pplx::task<void> SubmissionsApi::downloadSubmissionLogs(int32_t submissionId)
{


    std::shared_ptr<ApiConfiguration> apiConfiguration( m_ApiClient->getConfiguration() );
    utility::string_t path = utility::conversions::to_string_t("/submissions/{submission_id}/logs/download");
    boost::replace_all(path, utility::conversions::to_string_t("{") + utility::conversions::to_string_t("submission_id") + utility::conversions::to_string_t("}"), ApiClient::parameterToString(submissionId));
    ...
    {
        throw ApiException(400, utility::conversions::to_string_t("SubmissionsApi->downloadSubmissionLogs does not produce any supported media type"));
    }
    ...
    {
        throw ApiException(415, utility::conversions::to_string_t("SubmissionsApi->downloadSubmissionLogs does not consume any supported media type"));
    }
    ...
    .then([=](web::http::http_response response)
    {
        ...
        {
            throw ApiException(response.status_code()
                , utility::conversions::to_string_t("error calling downloadSubmissionLogs: ") + response.reason_phrase()
                , std::make_shared<std::stringstream>(response.extract_utf8string(true).get()));
        }
        ...
        if(response.headers().has(utility::conversions::to_string_t("Content-Type")))
        {
            ...
            {
                throw ApiException(500
                    , utility::conversions::to_string_t("error calling downloadSubmissionLogs: unexpected response type: ") + contentType
                    , std::make_shared<std::stringstream>(response.extract_utf8string(true).get()));
            }
        }
...
pplx::task<std::shared_ptr<SubmissionLogs>> SubmissionsApi::getSubmissionLogs(int32_t submissionId, boost::optional<int32_t> step, boost::optional<int32_t> logLines, boost::optional<utility::string_t> xFields)
{


    std::shared_ptr<ApiConfiguration> apiConfiguration( m_ApiClient->getConfiguration() );
    utility::string_t path = utility::conversions::to_string_t("/submissions/{submission_id}/logs");
    boost::replace_all(path, utility::conversions::to_string_t("{") + utility::conversions::to_string_t("submission_id") + utility::conversions::to_string_t("}"), ApiClient::parameterToString(submissionId));
    ...
    {
        throw ApiException(400, utility::conversions::to_string_t("SubmissionsApi->getSubmissionLogs does not produce any supported media type"));
    }
    ...
    {
        throw ApiException(415, utility::conversions::to_string_t("SubmissionsApi->getSubmissionLogs does not consume any supported media type"));
    }
    ...
    .then([=](web::http::http_response response)
    {
        ...
        {
            throw ApiException(response.status_code()
                , utility::conversions::to_string_t("error calling getSubmissionLogs: ") + response.reason_phrase()
                , std::make_shared<std::stringstream>(response.extract_utf8string(true).get()));
        }
        ...
        if(response.headers().has(utility::conversions::to_string_t("Content-Type")))
        {
            ...
            {
                throw ApiException(500
                    , utility::conversions::to_string_t("error calling getSubmissionLogs: unexpected response type: ") + contentType
                    , std::make_shared<std::stringstream>(response.extract_utf8string(true).get()));
            }
        }
    ...
    .then([=](utility::string_t response)
    {
        std::shared_ptr<SubmissionLogs> result(new SubmissionLogs());
        ...
        {
            throw ApiException(500
                , utility::conversions::to_string_t("error calling getSubmissionLogs: unsupported response type"));
        }

        return result;
    });
}
pplx::task<std::vector<std::shared_ptr<Submissions>>> SubmissionsApi::listSubmissions(boost::optional<utility::string_t> perPage, boost::optional<utility::string_t> page, boost::optional<utility::string_t> meta, boost::optional<utility::string_t> status, boost::optional<int32_t> graderId, boost::optional<int32_t> userId, boost::optional<utility::string_t> xFields)
{
...
pplx::task<std::shared_ptr<SubmissionRetry>> SubmissionsApi::retrySubmissions(std::shared_ptr<SubmissionRetryInput> payload, boost::optional<utility::string_t> xFields)
{

    // verify the required parameter 'payload' is set
    if (payload == nullptr)
    {
        throw ApiException(400, utility::conversions::to_string_t("Missing required parameter 'payload' when calling SubmissionsApi->retrySubmissions"));
    }


    std::shared_ptr<ApiConfiguration> apiConfiguration( m_ApiClient->getConfiguration() );
    utility::string_t path = utility::conversions::to_string_t("/submissions/retry");
    ...
    {
        throw ApiException(400, utility::conversions::to_string_t("SubmissionsApi->retrySubmissions does not produce any supported media type"));
    }
    ...
    {
        throw ApiException(415, utility::conversions::to_string_t("SubmissionsApi->retrySubmissions does not consume any supported media type"));
    }
    ...
    .then([=](web::http::http_response response)
    {
        ...
        {
            throw ApiException(response.status_code()
                , utility::conversions::to_string_t("error calling retrySubmissions: ") + response.reason_phrase()
                , std::make_shared<std::stringstream>(response.extract_utf8string(true).get()));
        }
        ...
        if(response.headers().has(utility::conversions::to_string_t("Content-Type")))
        {
            ...
            {
                throw ApiException(500
                    , utility::conversions::to_string_t("error calling retrySubmissions: unexpected response type: ") + contentType
                    , std::make_shared<std::stringstream>(response.extract_utf8string(true).get()));
            }
        }
    ...
    .then([=](utility::string_t response)
    {
        std::shared_ptr<SubmissionRetry> result(new SubmissionRetry());
        ...
        {
            throw ApiException(500
                , utility::conversions::to_string_t("error calling retrySubmissions: unsupported response type"));
        }
