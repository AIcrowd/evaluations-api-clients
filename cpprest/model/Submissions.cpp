...
web::json::value Submissions::toJson() const
{
    ...
    if(m_Minimal_runIsSet)
    {
        val[utility::conversions::to_string_t("minimal_run")] = ModelBase::toJson(m_Minimal_run);
    }
    if(m_User_idIsSet)
    {
...
void Submissions::fromJson(web::json::value& val)
{
    ...
    if(val.has_field(utility::conversions::to_string_t("minimal_run")))
    {
        web::json::value& fieldValue = val[utility::conversions::to_string_t("minimal_run")];
        if(!fieldValue.is_null())
        {
            setMinimalRun(ModelBase::boolFromJson(fieldValue));
        }
    }
...
void Submissions::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
    ...
    if(m_Minimal_runIsSet)
    {
        multipart->add(ModelBase::toHttpContent(namePrefix + utility::conversions::to_string_t("minimal_run"), m_Minimal_run));
    }
    if(m_User_idIsSet)
    {
...
void Submissions::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    ...
    if(multipart->hasContent(utility::conversions::to_string_t("minimal_run")))
    {
        setMinimalRun(ModelBase::boolFromHttpContent(multipart->getContent(utility::conversions::to_string_t("minimal_run"))));
    }
...
bool Submissions::isMinimalRun() const
{
    return m_Minimal_run;
}


void Submissions::setMinimalRun(bool value)
{
    m_Minimal_run = value;
    m_Minimal_runIsSet = true;
}
bool Submissions::minimalRunIsSet() const
{
    return m_Minimal_runIsSet;
}

void Submissions::unsetMinimal_run()
{
    m_Minimal_runIsSet = false;
}
