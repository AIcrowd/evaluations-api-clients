...
namespace IO.Swagger.Api
{
    ...
    public interface IGradersApi : IApiAccessor
    {
        ...
        /// <param name="xFields">An optional fields mask (optional)</param>
        /// <returns>ApiResponse of Grader</returns>
        ApiResponse<Grader> PutGraderDaoWithHttpInfo (int? graderId, Grader payload, string xFields = null);
        ...
        /// <param name="xFields">An optional fields mask (optional)</param>
        /// <returns>Task of Grader</returns>
        System.Threading.Tasks.Task<Grader> PutGraderDaoAsync (int? graderId, Grader payload, string xFields = null);
        ...
        /// <param name="xFields">An optional fields mask (optional)</param>
        /// <returns>Task of ApiResponse (Grader)</returns>
        System.Threading.Tasks.Task<ApiResponse<Grader>> PutGraderDaoAsyncWithHttpInfo (int? graderId, Grader payload, string xFields = null);
    ...
    public partial class GradersApi : IGradersApi
    {
        ...
        /// <returns></returns>
        public GradersApi(IO.Swagger.Client.Configuration configuration = null)
        {
        ...
        /// <param name="xFields">An optional fields mask (optional)</param>
        /// <returns>Grader</returns>
        public Grader PutGraderDao (int? graderId, Grader payload, string xFields = null)
        {
             ApiResponse<Grader> localVarResponse = PutGraderDaoWithHttpInfo(graderId, payload, xFields);
             return localVarResponse.Data;
        }
        ...
        /// <param name="xFields">An optional fields mask (optional)</param>
        /// <returns>ApiResponse of Grader</returns>
        public ApiResponse< Grader > PutGraderDaoWithHttpInfo (int? graderId, Grader payload, string xFields = null)
        {
            // verify the required parameter 'graderId' is set
            if (graderId == null)
                throw new ApiException(400, "Missing required parameter 'graderId' when calling GradersApi->PutGraderDao");
            // verify the required parameter 'payload' is set
            if (payload == null)
                throw new ApiException(400, "Missing required parameter 'payload' when calling GradersApi->PutGraderDao");
            ...
            if (ExceptionFactory != null)
            {
                Exception exception = ExceptionFactory("PutGraderDao", localVarResponse);
                if (exception != null) throw exception;
            }
        ...
        /// <param name="xFields">An optional fields mask (optional)</param>
        /// <returns>Task of Grader</returns>
        public async System.Threading.Tasks.Task<Grader> PutGraderDaoAsync (int? graderId, Grader payload, string xFields = null)
        {
             ApiResponse<Grader> localVarResponse = await PutGraderDaoAsyncWithHttpInfo(graderId, payload, xFields);
             return localVarResponse.Data;
        ...
        /// <param name="xFields">An optional fields mask (optional)</param>
        /// <returns>Task of ApiResponse (Grader)</returns>
        public async System.Threading.Tasks.Task<ApiResponse<Grader>> PutGraderDaoAsyncWithHttpInfo (int? graderId, Grader payload, string xFields = null)
        {
            // verify the required parameter 'graderId' is set
            if (graderId == null)
                throw new ApiException(400, "Missing required parameter 'graderId' when calling GradersApi->PutGraderDao");
