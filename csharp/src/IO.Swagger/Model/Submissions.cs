...
namespace IO.Swagger.Model
{
    ...
    public partial class Submissions :  IEquatable<Submissions>, IValidatableObject
    {
        ...
        public override string ToString()
        {
            ...
            sb.Append("  SubmissionCode: ").Append(SubmissionCode).Append("\n");
        ...
        public bool Equals(Submissions input)
        {
            ...
            return 
                ...
                (
                    this.SubmissionCode == input.SubmissionCode ||
                    (this.SubmissionCode != null &&
                    this.SubmissionCode.Equals(input.SubmissionCode))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.SubmissionCode != null)
                    hashCode = hashCode * 59 + this.SubmissionCode.GetHashCode();
                if (this.Status != null)
