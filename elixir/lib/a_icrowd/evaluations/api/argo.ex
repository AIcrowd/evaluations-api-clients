...
defmodule AIcrowd.Evaluations.Api.Argo do
  @moduledoc """
  ...
  """
  @spec post_generic_feedback_contract(Tesla.Env.client, String.t, integer(), AIcrowd.Evaluations.Model.GenericFeedback.t, keyword()) :: {:ok, nil} | {:error, Tesla.Env.t}
  ...
  {:error, info} on failure
  """
  @spec post_grader_feedback_dao(Tesla.Env.client, integer(), AIcrowd.Evaluations.Model.GraderFeedback.t, keyword()) :: {:ok, nil} | {:error, Tesla.Env.t}
  ...
  {:error, info} on failure
  """
  @spec post_submission_feedback_dao(Tesla.Env.client, integer(), AIcrowd.Evaluations.Model.SubmissionFeedback.t, keyword()) :: {:ok, nil} | {:error, Tesla.Env.t}
