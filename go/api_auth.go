...
func (a *AuthApiService) Login(ctx context.Context, payload Login, localVarOptionals *AuthApiLoginOpts) (AuthResponse, *http.Response, error) {
	var (
 ...
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param optional nil or *AuthApiLogoutOpts - Optional Parameters:
     * @param "XFields" (optional.String) -  An optional fields mask

@return AuthLogout
*/

type AuthApiLogoutOpts struct { 
	XFields optional.String
}

func (a *AuthApiService) Logout(ctx context.Context, localVarOptionals *AuthApiLogoutOpts) (AuthLogout, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Post")
		localVarPostBody   interface{}
		localVarFileName   string
		localVarFileBytes  []byte
		localVarReturnValue AuthLogout
	)
