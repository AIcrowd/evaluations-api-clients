 ...
 * @param optional nil or *LogoutAUserOpts - Optional Parameters:
     * @param "XFields" (optional.String) -  An optional fields mask

@return AuthLogout
*/

type LogoutAUserOpts struct { 
	XFields optional.String
}

func (a *AuthApiService) LogoutAUser(ctx context.Context, localVarOptionals *LogoutAUserOpts) (AuthLogout, *http.Response, error) {
	var (
...
func (a *AuthApiService) UserLogin(ctx context.Context, payload Login, localVarOptionals *UserLoginOpts) (AuthResponse, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Post")
		localVarPostBody   interface{}
		localVarFileName   string
