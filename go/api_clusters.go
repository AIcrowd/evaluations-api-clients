...
*/
func (a *ClustersApiService) DeleteClusterDao(ctx context.Context, clusterId int32) (*http.Response, error) {
	var (
...
func (a *ClustersApiService) GetGraderListDao(ctx context.Context, localVarOptionals *GetGraderListDaoOpts) ([]Cluster, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
...
func (a *ClustersApiService) PostGraderListDao(ctx context.Context, payload Cluster, localVarOptionals *PostGraderListDaoOpts) (Cluster, *http.Response, error) {
	var (
