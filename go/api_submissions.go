...
*/
func (a *SubmissionsApiService) DeleteSubmissionDao(ctx context.Context, submissionId int32) (*http.Response, error) {
	var (
...
*/
func (a *SubmissionsApiService) GetSubmissionDataDao(ctx context.Context, submissionId int32) (*http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Get")
		localVarPostBody   interface{}
		localVarFileName   string
