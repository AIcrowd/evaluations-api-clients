...
*/
func (a *SubmissionsApiService) DownloadSubmissionLogs(ctx context.Context, submissionId int32) (*http.Response, error) {
	var (
	...
	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/submissions/{submission_id}/logs/download"
	localVarPath = strings.Replace(localVarPath, "{"+"submission_id"+"}", fmt.Sprintf("%v", submissionId), -1)
 ...
 * @param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
 * @param payload
 * @param optional nil or *SubmissionsApiRetrySubmissionsOpts - Optional Parameters:
     * @param "XFields" (optional.String) -  An optional fields mask

@return SubmissionRetry
*/

type SubmissionsApiRetrySubmissionsOpts struct { 
	XFields optional.String
}

func (a *SubmissionsApiService) RetrySubmissions(ctx context.Context, payload SubmissionRetryInput, localVarOptionals *SubmissionsApiRetrySubmissionsOpts) (SubmissionRetry, *http.Response, error) {
	var (
		localVarHttpMethod = strings.ToUpper("Post")
		localVarPostBody   interface{}
		localVarFileName   string
		localVarFileBytes  []byte
		localVarReturnValue SubmissionRetry
	)

	// create path and map variables
	localVarPath := a.client.cfg.BasePath + "/submissions/retry"
