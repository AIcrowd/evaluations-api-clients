...
public class GradersApi {
     ...
     */
    public com.squareup.okhttp.Call archiveGraderCall(Integer graderId, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;

        // create path and map variables
        String localVarPath = "/graders/{grader_id}/archive"
    ...
    private com.squareup.okhttp.Call archiveGraderValidateBeforeCall(Integer graderId, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        
        // verify the required parameter 'graderId' is set
        if (graderId == null) {
            throw new ApiException("Missing the required parameter 'graderId' when calling archiveGrader(Async)");
        }
        

        com.squareup.okhttp.Call call = archiveGraderCall(graderId, progressListener, progressRequestListener);
        return call;
     ...
     */
    public void archiveGrader(Integer graderId) throws ApiException {
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<Void> archiveGraderWithHttpInfo(Integer graderId) throws ApiException {
        com.squareup.okhttp.Call call = archiveGraderValidateBeforeCall(graderId, null, null);
     ...
     */
    public com.squareup.okhttp.Call archiveGraderAsync(Integer graderId, final ApiCallback<Void> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = archiveGraderValidateBeforeCall(graderId, progressListener, progressRequestListener);
    ...
    /**
     * Build call for downloadGraderLogs
     * @param graderId  (required)
     * @param progressListener Progress listener
     * @param progressRequestListener Progress request listener
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call downloadGraderLogsCall(Integer graderId, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;

        // create path and map variables
        String localVarPath = "/graders/{grader_id}/logs/download"
            .replaceAll("\\{" + "grader_id" + "\\}", apiClient.escapeString(graderId.toString()));
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call downloadGraderLogsValidateBeforeCall(Integer graderId, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        
        // verify the required parameter 'graderId' is set
        if (graderId == null) {
            throw new ApiException("Missing the required parameter 'graderId' when calling downloadGraderLogs(Async)");
        }
        

        com.squareup.okhttp.Call call = downloadGraderLogsCall(graderId, progressListener, progressRequestListener);
        return call;
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public void downloadGraderLogs(Integer graderId) throws ApiException {
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<Void> downloadGraderLogsWithHttpInfo(Integer graderId) throws ApiException {
        com.squareup.okhttp.Call call = downloadGraderLogsValidateBeforeCall(graderId, null, null);
        return apiClient.execute(call);
    }
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call downloadGraderLogsAsync(Integer graderId, final ApiCallback<Void> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = downloadGraderLogsValidateBeforeCall(graderId, progressListener, progressRequestListener);
        apiClient.executeAsync(call, callback);
        return call;
    }
    /**
     ...
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call getGraderLogsCall(Integer graderId, Integer step, Integer logLines, String xFields, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call getGraderLogsValidateBeforeCall(Integer graderId, Integer step, Integer logLines, String xFields, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        com.squareup.okhttp.Call call = getGraderLogsCall(graderId, step, logLines, xFields, progressListener, progressRequestListener);
        return call;
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public GraderLogs getGraderLogs(Integer graderId, Integer step, Integer logLines, String xFields) throws ApiException {
        ApiResponse<GraderLogs> resp = getGraderLogsWithHttpInfo(graderId, step, logLines, xFields);
        return resp.getData();
    }
     ...
     * @param logLines Number of lines to fetch (optional)
     * @param xFields An optional fields mask (optional)
     * @return ApiResponse&lt;GraderLogs&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<GraderLogs> getGraderLogsWithHttpInfo(Integer graderId, Integer step, Integer logLines, String xFields) throws ApiException {
        com.squareup.okhttp.Call call = getGraderLogsValidateBeforeCall(graderId, step, logLines, xFields, null, null);
        Type localVarReturnType = new TypeToken<GraderLogs>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call getGraderLogsAsync(Integer graderId, Integer step, Integer logLines, String xFields, final ApiCallback<GraderLogs> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = getGraderLogsValidateBeforeCall(graderId, step, logLines, xFields, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<GraderLogs>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
    ...
    /**
     * Build call for unarchiveGrader
     * @param graderId  (required)
     * @param progressListener Progress listener
     * @param progressRequestListener Progress request listener
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call unarchiveGraderCall(Integer graderId, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;

        // create path and map variables
        String localVarPath = "/graders/{grader_id}/unarchive"
            .replaceAll("\\{" + "grader_id" + "\\}", apiClient.escapeString(graderId.toString()));
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call unarchiveGraderValidateBeforeCall(Integer graderId, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        
        // verify the required parameter 'graderId' is set
        if (graderId == null) {
            throw new ApiException("Missing the required parameter 'graderId' when calling unarchiveGrader(Async)");
        }
        

        com.squareup.okhttp.Call call = unarchiveGraderCall(graderId, progressListener, progressRequestListener);
        return call;
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public void unarchiveGrader(Integer graderId) throws ApiException {
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<Void> unarchiveGraderWithHttpInfo(Integer graderId) throws ApiException {
        com.squareup.okhttp.Call call = unarchiveGraderValidateBeforeCall(graderId, null, null);
        return apiClient.execute(call);
    }
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call unarchiveGraderAsync(Integer graderId, final ApiCallback<Void> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = unarchiveGraderValidateBeforeCall(graderId, progressListener, progressRequestListener);
        apiClient.executeAsync(call, callback);
        return call;
    }
    /**
