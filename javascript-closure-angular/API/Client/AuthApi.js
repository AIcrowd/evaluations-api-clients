 ...
 */
API.Client.AuthApi.prototype.login = function(payload, opt_xFields, opt_extraHttpRequestParams) {
  /** @const {string} */
  ...
  if (!payload) {
    throw new Error('Missing required parameter payload when calling login');
  }
 ...
 */
API.Client.AuthApi.prototype.logout = function(opt_xFields, opt_extraHttpRequestParams) {
  /** @const {string} */
