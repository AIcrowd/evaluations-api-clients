...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['AIcrowdEvaluations/ApiClient', 'AIcrowdEvaluations/model/GenericFeedback', 'AIcrowdEvaluations/model/GraderFeedback', 'AIcrowdEvaluations/model/SubmissionFeedback'], factory);
    ...
    root.AicrowdEvaluations.ArgoApi = factory(root.AicrowdEvaluations.ApiClient, root.AicrowdEvaluations.GenericFeedback, root.AicrowdEvaluations.GraderFeedback, root.AicrowdEvaluations.SubmissionFeedback);
  }
  ...
  /**
   * Argo service.
   * @module AIcrowdEvaluations/api/ArgoApi
   * @version 1.0.0
   */

  /**
   * Constructs a new ArgoApi. 
   * @alias module:AIcrowdEvaluations/api/ArgoApi
   * @class
  ...
  var exports = function(apiClient) {
     ...
     * @callback module:AIcrowdEvaluations/api/ArgoApi~postGenericFeedbackContractCallback
     ...
     * @param {module:AIcrowdEvaluations/model/GenericFeedback} payload 
     * @param {module:AIcrowdEvaluations/api/ArgoApi~postGenericFeedbackContractCallback} callback The callback function, accepting three arguments: error, data, response
     */
     ...
     * @callback module:AIcrowdEvaluations/api/ArgoApi~postGraderFeedbackDaoCallback
     * @param {String} error Error message, if any.
     * @param data This operation does not return a value.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {module:AIcrowdEvaluations/model/GraderFeedback} payload 
     * @param {module:AIcrowdEvaluations/api/ArgoApi~postGraderFeedbackDaoCallback} callback The callback function, accepting three arguments: error, data, response
     */
     ...
     * @callback module:AIcrowdEvaluations/api/ArgoApi~postSubmissionFeedbackDaoCallback
     * @param {String} error Error message, if any.
     * @param data This operation does not return a value.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {module:AIcrowdEvaluations/model/SubmissionFeedback} payload 
     * @param {module:AIcrowdEvaluations/api/ArgoApi~postSubmissionFeedbackDaoCallback} callback The callback function, accepting three arguments: error, data, response
     */
