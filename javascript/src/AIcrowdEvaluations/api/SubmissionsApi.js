...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['AIcrowdEvaluations/ApiClient', 'AIcrowdEvaluations/model/SubmissionRetry', 'AIcrowdEvaluations/model/SubmissionRetryInput', 'AIcrowdEvaluations/model/Submissions'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('../model/SubmissionRetry'), require('../model/SubmissionRetryInput'), require('../model/Submissions'));
  } else {
    // Browser globals (root is window)
    if (!root.AicrowdEvaluations) {
      root.AicrowdEvaluations = {};
    }
    root.AicrowdEvaluations.SubmissionsApi = factory(root.AicrowdEvaluations.ApiClient, root.AicrowdEvaluations.SubmissionRetry, root.AicrowdEvaluations.SubmissionRetryInput, root.AicrowdEvaluations.Submissions);
  }
}(this, function(ApiClient, SubmissionRetry, SubmissionRetryInput, Submissions) {
  'use strict';
