...
(function(factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['AIcrowdEvaluations/ApiClient', 'AIcrowdEvaluations/model/AuthLogout', 'AIcrowdEvaluations/model/AuthResponse', 'AIcrowdEvaluations/model/Cluster', 'AIcrowdEvaluations/model/Grader', 'AIcrowdEvaluations/model/GraderLogs', 'AIcrowdEvaluations/model/GraderMeta', 'AIcrowdEvaluations/model/Login', 'AIcrowdEvaluations/model/Organisation', 'AIcrowdEvaluations/model/OrganisationQuota', 'AIcrowdEvaluations/model/SubmissionLogs', 'AIcrowdEvaluations/model/SubmissionRetry', 'AIcrowdEvaluations/model/SubmissionRetryInput', 'AIcrowdEvaluations/model/Submissions', 'AIcrowdEvaluations/model/User', 'AIcrowdEvaluations/model/UserQuota', 'AIcrowdEvaluations/api/AuthApi', 'AIcrowdEvaluations/api/ClustersApi', 'AIcrowdEvaluations/api/GradersApi', 'AIcrowdEvaluations/api/OrganisationsApi', 'AIcrowdEvaluations/api/SubmissionsApi', 'AIcrowdEvaluations/api/UsersApi'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('./ApiClient'), require('./model/AuthLogout'), require('./model/AuthResponse'), require('./model/Cluster'), require('./model/Grader'), require('./model/GraderLogs'), require('./model/GraderMeta'), require('./model/Login'), require('./model/Organisation'), require('./model/OrganisationQuota'), require('./model/SubmissionLogs'), require('./model/SubmissionRetry'), require('./model/SubmissionRetryInput'), require('./model/Submissions'), require('./model/User'), require('./model/UserQuota'), require('./api/AuthApi'), require('./api/ClustersApi'), require('./api/GradersApi'), require('./api/OrganisationsApi'), require('./api/SubmissionsApi'), require('./api/UsersApi'));
  }
}(function(ApiClient, AuthLogout, AuthResponse, Cluster, Grader, GraderLogs, GraderMeta, Login, Organisation, OrganisationQuota, SubmissionLogs, SubmissionRetry, SubmissionRetryInput, Submissions, User, UserQuota, AuthApi, ClustersApi, GradersApi, OrganisationsApi, SubmissionsApi, UsersApi) {
  'use strict';
  ...
  var exports = {
    ...
    Grader: Grader,
    /**
     * The GraderLogs model constructor.
     * @property {module:AIcrowdEvaluations/model/GraderLogs}
     */
    ...
    /**
     * The SubmissionLogs model constructor.
     * @property {module:AIcrowdEvaluations/model/SubmissionLogs}
     */
