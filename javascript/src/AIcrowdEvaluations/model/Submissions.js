...
(function(root, factory) {
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('minimal_run'))
        obj.minimalRun = ApiClient.convertToType(data['minimal_run'], 'Boolean');
   ...
   * @member {Boolean} minimalRun
   */
  exports.prototype.minimalRun = undefined;
