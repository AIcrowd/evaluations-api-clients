...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/Organisation', 'model/OrganisationQuota'], factory);
    ...
    root.EvaluationsApi.OrganisationsApi = factory(root.EvaluationsApi.ApiClient, root.EvaluationsApi.Organisation, root.EvaluationsApi.OrganisationQuota);
  }
  ...
  var exports = function(apiClient) {
     ...
     * @callback module:api/OrganisationsApi~deleteOrganisationDaoCallback
     ...
     * @param {module:api/OrganisationsApi~deleteOrganisationDaoCallback} callback The callback function, accepting three arguments: error, data, response
     */
     ...
     * @callback module:api/OrganisationsApi~getOrganisationDaoCallback
     * @param {String} error Error message, if any.
     ...
     * @param {module:api/OrganisationsApi~getOrganisationDaoCallback} callback The callback function, accepting three arguments: error, data, response
     ...
     * @callback module:api/OrganisationsApi~getOrganisationListDaoCallback
     * @param {String} error Error message, if any.
     ...
     * @param {Object} opts Optional parameters
     * @param {String} opts.xFields An optional fields mask
     * @param {module:api/OrganisationsApi~getOrganisationListDaoCallback} callback The callback function, accepting three arguments: error, data, response
     ...
     * @callback module:api/OrganisationsApi~postOrganisationListDaoCallback
     * @param {String} error Error message, if any.
     * @param {module:model/Organisation} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {module:model/Organisation} payload 
     * @param {Object} opts Optional parameters
     * @param {String} opts.xFields An optional fields mask
     * @param {module:api/OrganisationsApi~postOrganisationListDaoCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/Organisation}
     */
     ...
     * @callback module:api/OrganisationsApi~putOrganisationDaoCallback
     * @param {String} error Error message, if any.
     * @param {module:model/Organisation} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {Object} opts Optional parameters
     * @param {String} opts.xFields An optional fields mask
     * @param {module:api/OrganisationsApi~putOrganisationDaoCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/Organisation}
     */
     ...
     * @callback module:api/OrganisationsApi~putQuotaDaoCallback
     * @param {String} error Error message, if any.
     * @param data This operation does not return a value.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {Number} organisationId Organisation identifier
     * @param {module:model/OrganisationQuota} payload 
     * @param {module:api/OrganisationsApi~putQuotaDaoCallback} callback The callback function, accepting three arguments: error, data, response
     */
