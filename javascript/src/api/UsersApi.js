...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/User', 'model/UserQuota'], factory);
    ...
    root.EvaluationsApi.UsersApi = factory(root.EvaluationsApi.ApiClient, root.EvaluationsApi.User, root.EvaluationsApi.UserQuota);
  }
  ...
  var exports = function(apiClient) {
     ...
     * @callback module:api/UsersApi~deleteUserDaoCallback
     ...
     * @param {module:api/UsersApi~deleteUserDaoCallback} callback The callback function, accepting three arguments: error, data, response
     */
     ...
     * @callback module:api/UsersApi~getUserDaoCallback
     * @param {String} error Error message, if any.
     ...
     * @param {module:api/UsersApi~getUserDaoCallback} callback The callback function, accepting three arguments: error, data, response
     ...
     * @callback module:api/UsersApi~getUserListDaoCallback
     * @param {String} error Error message, if any.
     ...
     * @param {Object} opts Optional parameters
     * @param {String} opts.xFields An optional fields mask
     * @param {module:api/UsersApi~getUserListDaoCallback} callback The callback function, accepting three arguments: error, data, response
     ...
     * @callback module:api/UsersApi~postUserListDaoCallback
     * @param {String} error Error message, if any.
     * @param {module:model/User} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
    ...
    /**
     * Create a new user
     * @param {module:model/User} payload 
     * @param {Object} opts Optional parameters
     * @param {String} opts.xFields An optional fields mask
     * @param {module:api/UsersApi~postUserListDaoCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/User}
     */
     ...
     * @callback module:api/UsersApi~putQuotaDaoCallback
     * @param {String} error Error message, if any.
     * @param data This operation does not return a value.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {Number} userId User identifier
     * @param {module:model/UserQuota} payload 
     * @param {module:api/UsersApi~putQuotaDaoCallback} callback The callback function, accepting three arguments: error, data, response
     */
     ...
     * @callback module:api/UsersApi~putUserDaoCallback
     * @param {String} error Error message, if any.
     * @param {module:model/User} data The data returned by the service call.
     * @param {String} response The complete HTTP response.
     */
     ...
     * @param {Object} opts Optional parameters
     * @param {String} opts.xFields An optional fields mask
     * @param {module:api/UsersApi~putUserDaoCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/User}
     */
