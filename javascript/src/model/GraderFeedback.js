...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.EvaluationsApi.GraderFeedback = factory(root.EvaluationsApi.ApiClient);
  }
   ...
   * @module model/GraderFeedback
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>GraderFeedback</code>.
   * @alias module:model/GraderFeedback
   * @class
   ...
   * @param {module:model/GraderFeedback} obj Optional instance to populate.
   * @return {module:model/GraderFeedback} The populated <code>GraderFeedback</code> instance.
   */
