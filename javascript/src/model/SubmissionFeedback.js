...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.EvaluationsApi.SubmissionFeedback = factory(root.EvaluationsApi.ApiClient);
  }
   ...
   * @module model/SubmissionFeedback
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>SubmissionFeedback</code>.
   * @alias module:model/SubmissionFeedback
   * @class
   ...
   * @param {module:model/SubmissionFeedback} obj Optional instance to populate.
   * @return {module:model/SubmissionFeedback} The populated <code>SubmissionFeedback</code> instance.
   */
