...
(function(root, factory) {
  ...
  describe('AIcrowdEvaluations', function() {
    describe('SubmissionsApi', function() {
      ...
      describe('getSubmissionDataDao', function() {
        it('should call getSubmissionDataDao successfully', function(done) {
          // TODO: uncomment, update parameter values for getSubmissionDataDao call
          /*
          var submissionId = 56;

          instance.getSubmissionDataDao(submissionId, function(error, data, response) {
            if (error) {
              done(error);
              return;
            }
