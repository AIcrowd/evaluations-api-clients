...
(function(root, factory) {
  ...
  describe('AIcrowdEvaluations', function() {
    describe('SubmissionsApi', function() {
      describe('createSubmission', function() {
        it('should call createSubmission successfully', function(done) {
          ...
          instance.createSubmission(payload, opts, function(error, data, response) {
            ...
            expect(data.minimalRun).to.be.a('boolean');
            expect(data.minimalRun).to.be(false);
      ...
      describe('downloadSubmissionLogs', function() {
        it('should call downloadSubmissionLogs successfully', function(done) {
          // TODO: uncomment, update parameter values for downloadSubmissionLogs call
          /*
          var submissionId = 56;

          instance.downloadSubmissionLogs(submissionId, function(error, data, response) {
            if (error) {
              done(error);
              return;
            }
      ...
      describe('getSubmissionLogs', function() {
        it('should call getSubmissionLogs successfully', function(done) {
          // TODO: uncomment, update parameter values for getSubmissionLogs call and complete the assertions
          /*
          var submissionId = 56;
          var opts = {};
          opts.step = 56;
          ...
          instance.getSubmissionLogs(submissionId, opts, function(error, data, response) {
            if (error) {
              done(error);
              return;
            }
            // TODO: update response assertions
            expect(data).to.be.a(AicrowdEvaluations.SubmissionLogs);
            expect(data.status).to.be.a('string');
            expect(data.status).to.be("");
