...
(function(root, factory) {
  ...
  describe('AIcrowdEvaluations', function() {
    describe('GraderLogs', function() {
      beforeEach(function() {
        instance = new AicrowdEvaluations.GraderLogs();
      });

      it('should create an instance of GraderLogs', function() {
        // TODO: update the code to test GraderLogs
        expect(instance).to.be.a(AicrowdEvaluations.GraderLogs);
      });
