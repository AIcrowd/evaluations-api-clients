...
(function(root, factory) {
  ...
  describe('AIcrowdEvaluations', function() {
    describe('Submissions', function() {
      ...
      it('should have the property minimalRun (base name: "minimal_run")', function() {
        // TODO: update the code to test the property minimalRun
        expect(instance).to.have.property('minimalRun');
        // expect(instance.minimalRun).to.be(expectedValueLiteral);
      });
