...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('Submissions', function() {
      ...
      it('should have the property submissionCode (base name: "submission_code")', function() {
        // TODO: update the code to test the property submissionCode
        expect(instance).to.have.property('submissionCode');
        // expect(instance.submissionCode).to.be(expectedValueLiteral);
      });
