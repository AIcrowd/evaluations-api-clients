...
class GradersApi(basePath: kotlin.String = "https://localhost/v1") : ApiClient(basePath) {
    ...
    * @return void
    */
    fun archiveGrader(graderId: kotlin.Int) : Unit {
        ...
        val localVariableConfig = RequestConfig(
            RequestMethod.POST,
            "/graders/{grader_id}/archive".replace("{"+"grader_id"+"}", "$graderId"),
    ...
    * @return void
    */
    fun unarchiveGrader(graderId: kotlin.Int) : Unit {
        val localVariableBody: kotlin.Any? = null
        val localVariableQuery: MultiValueMap = mapOf()
        ...
        val localVariableConfig = RequestConfig(
            RequestMethod.POST,
            "/graders/{grader_id}/unarchive".replace("{"+"grader_id"+"}", "$graderId"),
            query = localVariableQuery,
            headers = localVariableHeaders
        )
        val response = request<Unit>(
