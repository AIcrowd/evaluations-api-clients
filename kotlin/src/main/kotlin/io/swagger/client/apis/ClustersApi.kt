...
import io.swagger.client.models.Cluster
...
class ClustersApi(basePath: kotlin.String = "https://localhost/v1") : ApiClient(basePath) {
    ...
    */
    @Suppress("UNCHECKED_CAST")
    fun getGraderListDao(xFields: kotlin.String) : kotlin.Array<Cluster> {
        val localVariableBody: kotlin.Any? = null
        val localVariableQuery: MultiValueMap = mapOf()
    ...
    */
    @Suppress("UNCHECKED_CAST")
    fun postGraderListDao(payload: Cluster, xFields: kotlin.String) : Cluster {
