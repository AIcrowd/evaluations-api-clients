...
build = {
	type = "builtin",
	modules = {
		["aicrowd-evaluations.api.argo_api"] = "aicrowd-evaluations/api/argo_api.lua";
		...
		["aicrowd-evaluations.model.generic_feedback"] = "aicrowd-evaluations/model/generic_feedback.lua";
		["aicrowd-evaluations.model.grader"] = "aicrowd-evaluations/model/grader.lua";
		["aicrowd-evaluations.model.grader_feedback"] = "aicrowd-evaluations/model/grader_feedback.lua";
		...
		["aicrowd-evaluations.model.submission_feedback"] = "aicrowd-evaluations/model/submission_feedback.lua";
