...
#
package AIcrowdEvaluations::ApiClient;
...
use AIcrowdEvaluations::Configuration;
...
sub new {
    ...
    my $config;
    if ( $_[0] && ref $_[0] && ref $_[0] eq 'AIcrowdEvaluations::Configuration' ) {
        $config = $_[0];
    } else {
        $config = AIcrowdEvaluations::Configuration->new(@_);
    }
...
sub deserialize
{
    ...
    if (not defined $data) {
        ...
        my $_instance = use_module("AIcrowdEvaluations::Object::$class")->new;
        if (ref $data eq "HASH") {
