...
# @param int $cluster_id  (required)
{
    ...
    __PACKAGE__->method_documentation->{ 'delete_cluster_dao' } = { 
    	summary => '',
        params => $params,
        returns => undef,
        };
...
# @return void
#
sub delete_cluster_dao {
    my ($self, %args) = @_;

    # verify the required parameter 'cluster_id' is set
    unless (exists $args{'cluster_id'}) {
      croak("Missing the required parameter 'cluster_id' when calling delete_cluster_dao");
    }
...
# @param string $x_fields An optional fields mask (optional)
{
    ...
    __PACKAGE__->method_documentation->{ 'get_cluster_dao' } = { 
    	summary => '',
        params => $params,
        returns => 'Cluster',
        };
...
sub get_cluster_dao {
    ...
    # verify the required parameter 'cluster_id' is set
    unless (exists $args{'cluster_id'}) {
      croak("Missing the required parameter 'cluster_id' when calling get_cluster_dao");
    }
...
# @param string $x_fields An optional fields mask (optional)
{
    ...
    __PACKAGE__->method_documentation->{ 'get_cluster_list_dao' } = { 
    	summary => '',
        params => $params,
...
# @param string $x_fields An optional fields mask (optional)
{
    ...
    __PACKAGE__->method_documentation->{ 'post_cluster_list_dao' } = { 
    	summary => '',
        params => $params,
        returns => 'Cluster',
        };
...
# @return Cluster
#
sub post_cluster_list_dao {
    my ($self, %args) = @_;

    # verify the required parameter 'payload' is set
    unless (exists $args{'payload'}) {
      croak("Missing the required parameter 'payload' when calling post_cluster_list_dao");
    }
