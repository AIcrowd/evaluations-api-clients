...
#
package AIcrowdEvaluations::Configuration;
...
=head1 Name
        ...
        AIcrowdEvaluations::Configuration - holds the configuration for all AIcrowdEvaluations Modules
...
default: Swagger-Codegen/0.0.1/perl
...
sub new {
	...
	$p{http_timeout} //= 180;
	$p{http_user_agent} //= 'Swagger-Codegen/0.0.1/perl';
