...
#
package AIcrowdEvaluations::Role;
use utf8;
...
has api_factory => ( is => 'ro',
                     isa => 'AIcrowdEvaluations::ApiFactory',
                     builder => '_build_af',
                     lazy => 1,
...
has _cfg => ( is => 'ro',
              isa => 'AIcrowdEvaluations::Configuration',
              default => sub { AIcrowdEvaluations::Configuration->new() },
              );
...
sub _build_af {
	...
	return AIcrowdEvaluations::ApiFactory->new(%args);
}
