...
class SubmissionsApi
{
     ...
     * @return void
     */
    public function getSubmissionLogs($submission_id, $step = null, $log_lines = null)
    {
        $this->getSubmissionLogsWithHttpInfo($submission_id, $step, $log_lines);
    }
     ...
     * @return array of null, HTTP status code, HTTP response headers (array of strings)
     */
    public function getSubmissionLogsWithHttpInfo($submission_id, $step = null, $log_lines = null)
    {
        $returnType = '';
        $request = $this->getSubmissionLogsRequest($submission_id, $step, $log_lines);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getSubmissionLogsAsync($submission_id, $step = null, $log_lines = null)
    {
        return $this->getSubmissionLogsAsyncWithHttpInfo($submission_id, $step, $log_lines)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getSubmissionLogsAsyncWithHttpInfo($submission_id, $step = null, $log_lines = null)
    {
        $returnType = '';
        $request = $this->getSubmissionLogsRequest($submission_id, $step, $log_lines);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getSubmissionLogsRequest($submission_id, $step = null, $log_lines = null)
    {
        // verify the required parameter 'submission_id' is set
        if ($submission_id === null || (is_array($submission_id) && count($submission_id) === 0)) {
            throw new \InvalidArgumentException(
