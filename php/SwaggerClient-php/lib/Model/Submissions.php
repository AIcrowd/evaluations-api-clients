...
class Submissions implements ModelInterface, ArrayAccess
{
    ...
    protected static $setters = [
        ...
        'submission_code' => 'setSubmissionCode',
        'status' => 'setStatus',
        'output' => 'setOutput',
    ...
    protected static $getters = [
        ...
        'submission_code' => 'getSubmissionCode',
        'status' => 'getStatus',
        'output' => 'getOutput',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['submission_code'] = isset($data['submission_code']) ? $data['submission_code'] : null;
    ...
    {
        return $this->container['submission_code'];
    }
     ...
     * @return $this
     */
    public function setSubmissionCode($submission_code)
    {
        $this->container['submission_code'] = $submission_code;
