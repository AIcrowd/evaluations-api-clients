...
class Submissions implements ModelInterface, ArrayAccess
{
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['minimal_run'] = isset($data['minimal_run']) ? $data['minimal_run'] : null;
     ...
     * @return bool
     */
    public function getMinimalRun()
    {
        return $this->container['minimal_run'];
    }

    /**
     * Sets minimal_run
     *
     * @param bool $minimal_run Remove steps like build-image, services, etc from the workflow. Only valid for retries
     *
     * @return $this
     */
    public function setMinimalRun($minimal_run)
    {
        $this->container['minimal_run'] = $minimal_run;
