...
class Organisation(object):
    ...
    def __init__(self, id=None, name=None, poc_email=None, created_on=None, total_quota=None, quota=None, _configuration=None):  # noqa: E501
    ...
    def poc_email(self, poc_email):
        ...
        :type: str
        """
        if self._configuration.client_side_validation and poc_email is None:
