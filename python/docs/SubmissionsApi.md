...
# **get_submission_logs**
> SubmissionLogs get_submission_logs(submission_id, step=step, log_lines=log_lines, x_fields=x_fields)
...
try:
    api_response = api_instance.get_submission_logs(submission_id, step=step, log_lines=log_lines, x_fields=x_fields)
    pprint(api_response)
except ApiException as e:
