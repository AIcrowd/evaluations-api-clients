...
module AIcrowdEvaluations
  class Organisation
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'poc_email')
      ...
      if attributes.has_key?(:'total_quota')
        self.total_quota = attributes[:'total_quota']
      end
    ...
    def list_invalid_properties
      ...
      if @poc_email.nil?
        invalid_properties.push('invalid value for "poc_email", poc_email cannot be nil.')
      end
    ...
    def hash
      [id, name, poc_email, created_on, total_quota, quota].hash
    end
