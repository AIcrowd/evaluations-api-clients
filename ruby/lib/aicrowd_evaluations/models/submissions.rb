...
module AIcrowdEvaluations
  class Submissions
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'minimal_run')
        self.minimal_run = attributes[:'minimal_run']
      end
    ...
    def hash
      [id, created, updated, grader_id, submission_data, status, output, additional_outputs, logs, started, ended, meta, wf_name, workflow_priority, minimal_run, user_id, organisation_id].hash
    end
