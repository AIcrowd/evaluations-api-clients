...
module SwaggerClient
  class Submissions
    ...
    def initialize(attributes = {})
      ...
      if attributes.has_key?(:'submission_code')
        self.submission_code = attributes[:'submission_code']
      end
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          submission_code == o.submission_code &&
          status == o.status &&
          output == o.output &&
    ...
    def hash
      [id, created, updated, participant_id, round_id, grader_id, submission_code, status, output, additional_outputs, logs, started, ended, meta, user_id, organisation_id].hash
    end
