...
# Unit tests for SwaggerClient::OrganisationQuota
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'OrganisationQuota' do
  before do
    # run before each test
    @instance = SwaggerClient::OrganisationQuota.new
  end
  ...
  describe 'test an instance of OrganisationQuota' do
    it 'should create an instance of OrganisationQuota' do
      expect(@instance).to be_instance_of(SwaggerClient::OrganisationQuota)
    end
  end
